        ...
        if (result.length > 0) {
          db.query(
            ...
            (updateErr, updateResult) => {
              ...
              return res.status(200).json({ message: "Report inserted successfully", result: updateResult });
            }
          );
        } else {
          ...
          db.query(
            ...
            (insertErr, insertResult) => {
              ...
              return res.status(200).json({ message: "Report inserted successfully", result: insertResult });
            }
          );
        }
      }
