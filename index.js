...
const corsOptions = {
  origin: 'https://amourette.no', // Replace with the domain of your React app
  methods: ['GET', 'POST', 'PUT', 'DELETE'], // Allow only certain HTTP methods if needed
  allowedHeaders: ['Content-Type', 'Authorization'], // Specify headers you need
  credentials: true, //
};
